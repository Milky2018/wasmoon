...
(component definition $Tester
  (component $C
    ...
    (func (export "async-async-func") async (canon lift (core func $cm "async-async-func") async (callback (core func $cm "async-async-func-cb"))))
  ...
  (component $D
    ...
    (core module $Core
      ...
      (func (export "trap-if-sync-stream-read")
        (call $stream.read (i32.const 0xdead) (i32.const 0xbeef) (i32.const 0xdead))
        unreachable
      )
      (func (export "trap-if-sync-stream-write")
        (call $stream.write (i32.const 0xdead) (i32.const 0xbeef) (i32.const 0xdead))
        unreachable
      )
    ...
    (func (export "trap-if-async-calls-sync-and-blocks") async (canon lift (core func $core "trap-if-async-calls-sync-and-blocks") async (callback (core func $core "unreachable-cb"))))
...
(assert_trap (invoke "trap-if-sync-call-async1") "unreachable")
(component instance $i $Tester)
(assert_trap (invoke "trap-if-sync-call-async2") "unreachable")
(component instance $i $Tester)
...
(component instance $i $Tester)
(assert_trap (invoke "trap-if-invalid-callback-code" (u32.const 3)) "unsupported callback code")
(component instance $i $Tester)
(assert_trap (invoke "trap-if-invalid-callback-code" (u32.const 4)) "unsupported callback code")
(component instance $i $Tester)
(assert_trap (invoke "trap-if-invalid-callback-code" (u32.const 15)) "unsupported callback code")
(component instance $i $Tester)
...
(component instance $i $Tester)
(assert_trap (invoke "trap-if-sync-cancel") "handle index")
(component instance $i $Tester)
(assert_trap (invoke "trap-if-sync-stream-read") "out of bounds")
(component instance $i $Tester)
(assert_trap (invoke "trap-if-sync-stream-write") "out of bounds")
(component instance $i $Tester)
(assert_trap (invoke "trap-if-sync-future-read") "out of bounds")
(component instance $i $Tester)
(assert_trap (invoke "trap-if-sync-future-write") "out of bounds")
(component instance $i $Tester)
(assert_trap (invoke "trap-if-sync-stream-cancel-read") "handle index")
(component instance $i $Tester)
(assert_trap (invoke "trap-if-sync-stream-cancel-write") "handle index")
(component instance $i $Tester)
(assert_trap (invoke "trap-if-sync-future-cancel-read") "handle index")
(component instance $i $Tester)
(assert_trap (invoke "trap-if-sync-future-cancel-write") "handle index")
