...
Stable semantic environment fields are reused only inside a short basic-block
window and never across calls. This target-local decision removes nearby
duplicate loads while bounding live ranges; mutable fields are always
rematerialized. No physical register is reserved for embedding context data.
