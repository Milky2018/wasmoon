...
int wasmoon_windows_setjmp(sigjmp_buf env);
__declspec(noreturn) void wasmoon_windows_longjmp(sigjmp_buf env, int value);
// Only generated SysV guest code calls this assembly entry.
int wasmoon_windows_guest_setjmp(sigjmp_buf env, int save_mask);
#else
