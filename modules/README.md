...
| `Milky2018/machv` | Canonical virtual-register machine IR. | `Function`, `FunctionBuilder`, `Block`, `Inst`, `Opcode`, `Terminator`, `ValueKind`, `PReg`, `VReg`, ABI locations, stack effects, verification, and printing. |
...
`machv_emit`, `milkir_machv`, and concrete machine-target packages) must not
import `Milky2018/wasmoon`.
