---
name: moon-ide
description: Code Navigation with `moon ide` for precise symbol lookup and reference finding in MoonBit projects. Use when finding symbol definitions, exploring code references, or navigating complex codebases with goto-definition and find-references commands.
---
