...
| --- | ---: | --- | --- | --- | --- |
| [ISS-567](ISS-567.md) | 1 | bug | unassigned | Diagnose the intermittent macOS misc JIT timeout | wasi, preview3, acceptance |
| [ISS-571](ISS-571.md) | 1 | task | codex | Resolve external HTTP expectations against the pinned WIT | wasi, preview3, acceptance |
| [ISS-572](ISS-572.md) | 1 | bug | codex | Integrate native WASI readiness with the asynchronous HTTP driver | wasi, preview3, acceptance |
...
| [ISS-450](ISS-450.md) | 2 | task | codex | Allocate directly into VCode allocation tables | machv, regalloc, adapter, architecture, compile-time, performance, aarch64, x64, agent |
| [ISS-576](ISS-576.md) | 2 | task | unassigned | Audit remaining compiler and runtime package boundaries | architecture, packages |

## Unresolved Issues

| ID | Status | Priority | Type | Assignee | Blocked by | Blocks | Title |
| --- | --- | ---: | --- | --- | --- | --- | --- |
| [ISS-565](ISS-565.md) | in_progress | 1 | feature | codex | none | none | Compose HTTP imports into command execution when requested |
| [ISS-451](ISS-451.md) | deferred | 0 | task | codex | none | none | Reuse one serial module compilation context |
| [ISS-567](ISS-567.md) | open | 1 | bug | unassigned | none | none | Diagnose the intermittent macOS misc JIT timeout |
| [ISS-571](ISS-571.md) | open | 1 | task | codex | none | none | Resolve external HTTP expectations against the pinned WIT |
| [ISS-572](ISS-572.md) | open | 1 | bug | codex | none | none | Integrate native WASI readiness with the asynchronous HTTP driver |
...
| [ISS-450](ISS-450.md) | open | 2 | task | codex | none | none | Allocate directly into VCode allocation tables |
| [ISS-568](ISS-568.md) | blocked | 2 | task | codex | none | none | Preserve structured TLS failure categories for WASI HTTP |
| [ISS-576](ISS-576.md) | open | 2 | task | unassigned | none | none | Audit remaining compiler and runtime package boundaries |
...
graph TD
  ...
  ISS_459["ISS-459: Rebuild MilkIR around an authoritative DFG and staged optimizer"]
  ...
  ISS_525["ISS-525: Port the complete runtime to native Windows AMD64"]
  ISS_526["ISS-526: Validate trailing-slash symlink traversal at the WASI capability boundary"]
  ISS_527["ISS-527: Support the Microsoft C compiler and validate it in Windows CI"]
  ISS_528["ISS-528: Wait for exclusive Windows input without readiness polling"]
  ISS_529["ISS-529: Verify developer-mode symlinks and preserve Windows privilege errors"]
  ISS_530["ISS-530: Complete and verify WASIp1 across supported native platforms"]
  ISS_531["ISS-531: Inventory the complete WASIp1 contract"]
  ISS_532["ISS-532: Execute Preview 1 path operations through held directory capabilities"]
  ISS_533["ISS-533: Implement file allocation and synchronization semantics"]
  ISS_534["ISS-534: Implement WASIp1 socket operations and host injection"]
  ISS_535["ISS-535: Define explicit host policy for Preview 1 process signals"]
  ISS_536["ISS-536: Validate and publish the native WASIp1 support matrix"]
  ISS_537["ISS-537: Execute interpreter calls and control flow on explicit stacks"]
  ISS_538["ISS-538: Implement invocation deadlines for both execution engines"]
  ISS_539["ISS-539: Measure and improve compilation costs after the explicit-stack release"]
  ...
  ISS_563["ISS-563: Audit WASI 0.3 acceptance against pinned contracts"]
  ISS_564["ISS-564: Support compatible WASI imports used by real Preview 3 guests"]
  ISS_565["ISS-565: Compose HTTP imports into command execution when requested"]
  ISS_566["ISS-566: Integrate trustworthy external WASI 0.3 acceptance gates"]
  ISS_567["ISS-567: Diagnose the intermittent macOS misc JIT timeout"]
  ISS_568["ISS-568: Preserve structured TLS failure categories for WASI HTTP"]
  ISS_569["ISS-569: Preserve host exits and stream progress through canonical calls"]
  ...
  ISS_574["ISS-574: Restore strict nightly CI and Windows Preview 3 acceptance"]
  ISS_575["ISS-575: Replace prefixed subsystem files with semantic packages"]
