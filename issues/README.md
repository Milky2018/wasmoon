...
| --- | ---: | --- | --- | --- | --- |
| [ISS-365](ISS-365.md) | 0 | bug | unassigned | Fix AMD64 JIT out-of-bounds traps in large algorithm functions | amd64, jit, correctness, memory, algorithms |
| [ISS-366](ISS-366.md) | 1 | bug | unassigned | Release the core execution engine when a component linker closes | component-model, lifecycle, teardown, memory, sanitizers, agent |
| [ISS-375](ISS-375.md) | 1 | bug | unassigned | Keep managed JIT contexts alive while raw pointers are in use | native-jit, ffi, memory-safety, sanitizer, tests |
| [ISS-364](ISS-364.md) | 2 | task | unassigned | Reduce the residual AEGIS parity gap | aarch64, jit, performance, aegis |
...
| --- | --- | ---: | --- | --- | --- | --- | --- |
| [ISS-365](ISS-365.md) | open | 0 | bug | unassigned | none | none | Fix AMD64 JIT out-of-bounds traps in large algorithm functions |
| [ISS-366](ISS-366.md) | open | 1 | bug | unassigned | none | none | Release the core execution engine when a component linker closes |
| [ISS-375](ISS-375.md) | open | 1 | bug | unassigned | none | none | Keep managed JIT contexts alive while raw pointers are in use |
| [ISS-364](ISS-364.md) | open | 2 | task | unassigned | none | none | Reduce the residual AEGIS parity gap |
