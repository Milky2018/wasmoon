...
| --- | ---: | --- | --- | --- | --- |
| [ISS-368](ISS-368.md) | 2 | task | unassigned | Bring down the cost of the native sanitizer gate | ci, sanitizers, build-time, agent |
...
| [ISS-378](ISS-378.md) | 2 | bug | unassigned | Fix cycle-context poisoning in e-graph extraction memoization | milkir, egraph, correctness, agent |
| [ISS-379](ISS-379.md) | 2 | bug | unassigned | Stop silently swallowing e-class type conflicts | milkir, egraph, correctness, agent |
| [ISS-380](ISS-380.md) | 2 | bug | unassigned | Remove unbounded native recursion from e-graph build and write-back | milkir, egraph, robustness, agent |
| [ISS-376](ISS-376.md) | 3 | bug | unassigned | Route CLI diagnostics to stderr and fail with non-zero exits | cli, diagnostics, exit-codes, agent |
| [ISS-381](ISS-381.md) | 3 | task | unassigned | Make e-graph rebuild incremental and retire the fixpoint trap API | milkir, egraph, performance, agent |
| [ISS-382](ISS-382.md) | 3 | chore | unassigned | Delete the consumer-less e-graph use-def map | milkir, egraph, cleanup, agent |
| [ISS-383](ISS-383.md) | 3 | task | unassigned | Report rule progress explicitly instead of via merge root identity | milkir, egraph, api-design, agent |
| [ISS-384](ISS-384.md) | 3 | task | unassigned | Stop paying full extraction for the constant-only harvest | milkir, egraph, compile-time, performance, agent |
...
| [ISS-368](ISS-368.md) | open | 2 | task | unassigned | none | none | Bring down the cost of the native sanitizer gate |
...
| [ISS-377](ISS-377.md) | open | 2 | feature | unassigned | ISS-378 | none | Elaborate e-graph extraction results back into MilkIR |
| [ISS-378](ISS-378.md) | open | 2 | bug | unassigned | none | ISS-377 | Fix cycle-context poisoning in e-graph extraction memoization |
| [ISS-379](ISS-379.md) | open | 2 | bug | unassigned | none | none | Stop silently swallowing e-class type conflicts |
| [ISS-380](ISS-380.md) | open | 2 | bug | unassigned | none | none | Remove unbounded native recursion from e-graph build and write-back |
| [ISS-376](ISS-376.md) | open | 3 | bug | unassigned | none | none | Route CLI diagnostics to stderr and fail with non-zero exits |
| [ISS-381](ISS-381.md) | open | 3 | task | unassigned | none | none | Make e-graph rebuild incremental and retire the fixpoint trap API |
| [ISS-382](ISS-382.md) | open | 3 | chore | unassigned | none | none | Delete the consumer-less e-graph use-def map |
| [ISS-383](ISS-383.md) | open | 3 | task | unassigned | none | none | Report rule progress explicitly instead of via merge root identity |
| [ISS-384](ISS-384.md) | open | 3 | task | unassigned | none | none | Stop paying full extraction for the constant-only harvest |
