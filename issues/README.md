...
| [ISS-404](ISS-404.md) | 2 | task | unassigned | Add a materialization-cost predicate for cheap pure values | milkir, optimization, regalloc, agent |
| [ISS-414](ISS-414.md) | 2 | bug | unassigned | Diagnose an intermittent MilkIR whitebox stall | milkir, testing, compile-time, performance, agent |
...
| [ISS-399](ISS-399.md) | 3 | task | unassigned | `regalloc/planning` is a 2129-line package that only its tests use | regalloc, dead-code, agent |
| [ISS-407](ISS-407.md) | 3 | task | unassigned | Fold constant offsets into load and store displacements | milkir_machv, aarch64, codegen, code-size, agent |
...
| [ISS-403](ISS-403.md) | open | 2 | bug | unassigned | ISS-404, ISS-405, ISS-406, ISS-407 | none | CSE merges repeated constants into long live ranges that nothing rematerializes |
| [ISS-404](ISS-404.md) | open | 2 | task | unassigned | none | ISS-403, ISS-405 | Add a materialization-cost predicate for cheap pure values |
| [ISS-405](ISS-405.md) | open | 2 | task | unassigned | ISS-404 | ISS-403, ISS-406 | Rebuild marked values once per using block during elaboration |
| [ISS-414](ISS-414.md) | open | 2 | bug | unassigned | none | none | Diagnose an intermittent MilkIR whitebox stall |
| [ISS-415](ISS-415.md) | deferred | 2 | feature | unassigned | none | none | Replace fragment-preallocation Fast with instruction-state allocation |
...
| [ISS-399](ISS-399.md) | open | 3 | task | unassigned | none | none | `regalloc/planning` is a 2129-line package that only its tests use |
| [ISS-406](ISS-406.md) | open | 3 | task | unassigned | ISS-405 | ISS-403 | Fold the AArch64 EnvironmentField remat into the shared mechanism |
| [ISS-407](ISS-407.md) | open | 3 | task | unassigned | none | ISS-403 | Fold constant offsets into load and store displacements |
| [ISS-177](ISS-177.md) | deferred | 4 | bug | unassigned | none | none | Implement a Windows fd readiness backend for poll_oneoff |
| [ISS-389](ISS-389.md) | open | 4 | chore | unassigned | none | none | `wasmoon/sanitizer_testsuite` is named after a gate that no longer exists |
...
graph TD
  ...
  ISS_399["ISS-399: `regalloc/planning` is a 2129-line package that only its tests use"]
  ...
  ISS_405["ISS-405: Rebuild marked values once per using block during elaboration"]
  ...
  ISS_415["ISS-415: Replace fragment-preallocation Fast with instruction-state allocation"]
  ISS_002 --> ISS_003
  ISS_002 --> ISS_004
  ISS_003 --> ISS_005
  ISS_004 --> ISS_005
