...
| [ISS-414](ISS-414.md) | 2 | bug | unassigned | Full native suite stalls in the MilkIR whitebox executable | milkir, testing, compile-time, performance, agent |
...
| --- | --- | ---: | --- | --- | --- | --- | --- |
| [ISS-408](ISS-408.md) | in_progress | 1 | epic | codex | ISS-414 | none | Rebuild regalloc around principled range allocation |
...
| [ISS-414](ISS-414.md) | open | 2 | bug | unassigned | none | ISS-408 | Full native suite stalls in the MilkIR whitebox executable |
...
graph TD
  ...
  ISS_414["ISS-414: Full native suite stalls in the MilkIR whitebox executable"]
  ISS_002 --> ISS_003
  ISS_002 --> ISS_004
  ISS_003 --> ISS_005
  ISS_004 --> ISS_005
