...
| [ISS-442](ISS-442.md) | 1 | task | unassigned | Remove snapshot allocation from target lowering | machv, target-lowering, compile-time, performance, aarch64, x64, agent |
...
| [ISS-442](ISS-442.md) | open | 1 | task | unassigned | none | none | Remove snapshot allocation from target lowering |
...
graph TD
  ...
  ISS_442["ISS-442: Remove snapshot allocation from target lowering"]
