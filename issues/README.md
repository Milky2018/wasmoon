...
| --- | ---: | --- | --- | --- | --- |
| [ISS-145](ISS-145.md) | 1 | task | codex | Finalize the semantic opcode contract | milkir, docs, api, validation, cleanup, agent |
...
| [ISS-145](ISS-145.md) | open | 1 | task | codex | none | none | Finalize the semantic opcode contract |
