...
| --- | --- | ---: | --- | --- | --- | --- | --- |
| [ISS-558](ISS-558.md) | in_progress | 1 | bug | codex | none | none | Respect the response-body first-byte timeout |
| [ISS-559](ISS-559.md) | in_progress | 1 | bug | codex | none | none | Cancel network reads when HTTP bodies are abandoned |
| [ISS-560](ISS-560.md) | in_progress | 1 | bug | codex | none | none | Validate HTTP URI components with an ecosystem parser |
