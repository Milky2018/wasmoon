...
| [ISS-399](ISS-399.md) | 3 | task | unassigned | `regalloc/planning` is a 1779-line package that only its tests use | regalloc, dead-code, agent |
...
| [ISS-399](ISS-399.md) | open | 3 | task | unassigned | none | none | `regalloc/planning` is a 1779-line package that only its tests use |
